...
void Copter::loop()
{
	...
	if (sentral.interrupt())
		sentral.read();
	else
		hal.console->printf("No interrupt from Sentral...\n");
}
...
void Copter::fast_loop()
{
    ...
    motors_output();		// Controls motor. Nothing to change here check. /library/AP_MotorsMulticopter.cpp

    // Inertial Nav
    // --------------------
    read_inertia();			//Arducopter/inertia.cpp

    // check if ekf has reset target heading
    check_ekf_yaw_reset();		//Arducopter/Attitude.cpp

    // run the attitude controllers
    update_flight_mode();		//Arducopter/flight_mode.cpp
